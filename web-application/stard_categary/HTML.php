...
<?php
    ...
    echo  $cid =   1;
        ...
        $query ="SELECT   `Id` ,`question_code`, `q_id`,`categary_name`from quez_question JOIN categary on quez_question.categary_id = categary.cid JOIN question_code ON quez_question.categary_id = question_code.code_id where question_code.code_id = {$cid}  GROUP By question_code";
